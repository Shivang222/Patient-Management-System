...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService = createFargateService("AuthService",
                ...
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET", "fBHLJ4pPrHZ0mhPboIFk+iInxfB+sy1Qab00J7F++lU="));
    ...
    // auth-service.patient-management
    ...
    private FargateService createFargateService(String id, String imageName, List<Integer> ports, DatabaseInstance databaseInstance, Map<String, String> additionalEnvVars) {
        ...
        if(databaseInstance != null) {
            ...
            envVars.put("SPRING_DATASOURCE_PASSWORD", databaseInstance.getSecret().secretValueFromJson("password").toString());
